...
import image1 from "../image/picWide.jpg"
import image2 from "../image/pic3.jpg"
import image3 from "../image/pic2wide.jpg"
  ...
  return (
    <section className="hero" style={{backgroundImage: `url(${backGrounds[currentBackground]})`}}>
      <div className="content">
        ...
        <div>
          <button class="start" onClick={() => setTimeOn(true)}>Start</button>
